...
hello_world.core.xScale = (function hello_world$core$xScale(x){
var getXCoord = d3.scaleLinear().domain([(0),(1000)]).range([(0),(500)]);
return getXCoord.call(null,x);
});
console.log(hello_world.core.xScale.call(null,(100)));
cljs.core.println.call(null,hello_world.core.xScale.call(null,(100)));
hello_world.core.mapBars = (function hello_world$core$mapBars(bar){
console.log(hello_world.core.xScale.call(null,bar.call(null,new cljs.core.Keyword(null,"value","value",305978217))));

return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-red.h4.mv3","div.bg-red.h4.mv3",-47862244),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),clojure.string.join.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hello_world.core.xScale.call(null,bar.call(null,new cljs.core.Keyword(null,"value","value",305978217))),"px"], null))], null)], null)], null);
});
hello_world.core.multiply.call(null,(2),(3));
