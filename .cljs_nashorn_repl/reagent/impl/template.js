...
var G__12296 = o;
(G__12296[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12300 = o;
(G__12300[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12305 = props;
var G__12305__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__12305,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12305);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12305__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12306){
...
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__12307,map__12307__$1,props,class$){
return (function (c){
...
});})(map__12307,map__12307__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12309){
var map__12310 = p__12309;
var map__12310__$1 = ((((!((map__12310 == null)))?(((((map__12310.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12310.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12310):map__12310);
var on_write = cljs.core.get.call(null,map__12310__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__12310,map__12310__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__12310,map__12310__$1,on_write))
);
} else {
...
var G__12313 = jsprops;
(G__12313["defaultValue"] = value);

(G__12313["onChange"] = ((function (G__12313,v,value,on_change){
return (function (p1__12312_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12312_SHARP_);
});})(G__12313,v,value,on_change))
);
...
var vec__12316 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12316,(0),null);
var id = cljs.core.nth.call(null,vec__12316,(1),null);
var class$ = cljs.core.nth.call(null,vec__12316,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___12320 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___12320 == null)){
} else {
var key_12321 = temp__5461__auto___12320;
...
var temp__5461__auto___12322 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___12322 == null)){
} else {
var key_12323 = temp__5461__auto___12322;
reagent.impl.template.oset.call(null,jsprops,"key",key_12323);
}
...
var G__12324 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__12324["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12327){
var G__12328 = cljs.core.first.call(null,seq12327);
var seq12327__$1 = cljs.core.next.call(null,seq12327);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12328,seq12327__$1);
});
...
break;
default:
var G__12334 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__12334;
continue;
...
var n__4408__auto___12336 = a.length;
var i_12337 = (0);
while(true){
if((i_12337 < n__4408__auto___12336)){
(a[i_12337] = reagent.impl.template.as_element.call(null,(a[i_12337])));

var G__12338 = (i_12337 + (1));
i_12337 = G__12338;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___12339 = a.length;
var i_12340 = (0);
while(true){
if((i_12340 < n__4408__auto___12339)){
var val_12341 = (a[i_12340]);
if(((cljs.core.vector_QMARK_.call(null,val_12341)) && ((reagent.impl.template.key_from_vec.call(null,val_12341) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12340] = reagent.impl.template.as_element.call(null,val_12341));

var G__12342 = (i_12340 + (1));
i_12340 = G__12342;
continue;
} else {
}
...
var ctx = ({});
var vec__12343 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12343,(0),null);
var derefed = cljs.core.nth.call(null,vec__12343,(1),null);
...
var G__12346 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12346) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__12346){
