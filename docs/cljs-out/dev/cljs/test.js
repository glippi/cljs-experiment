...
var G__10038 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10038,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10038;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10040){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10041,G__10042,seq10040__$2);
});
...
var file = cljs.core.get.call(null,map__10047__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10047__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10047__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10047,map__10047__$1,file,line,column){
return (function (p1__10046_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10046_SHARP_));
});})(map__10047,map__10047__$1,file,line,column))
...
var temp__5457__auto___10049 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10049)){
var message_10050 = temp__5457__auto___10049;
cljs.core.println.call(null,message_10050);
} else {
}
...
var temp__5457__auto___10051 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10051)){
var message_10052 = temp__5457__auto___10051;
cljs.core.println.call(null,message_10052);
} else {
}
...
var output_dir__$1 = (function (){var G__10053 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10053),"/"].join('');
} else {
return G__10053;
}
})();
...
var G__10055 = exception.stack;
var G__10055__$1 = (((G__10055 == null))?null:clojure.string.split_lines.call(null,G__10055));
var G__10055__$2 = (((G__10055__$1 == null))?null:cljs.core.get.call(null,G__10055__$1,depth));
if((G__10055__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10055__$2);
}
} else {
...
var vec__10056 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10056,(0),null);
var column = cljs.core.nth.call(null,vec__10056,(1),null);
var vec__10059 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10059,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10059,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10059,(2),null);
...
var m__$1 = (function (){var G__10062 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__10062__$1 = (((G__10062 instanceof cljs.core.Keyword))?G__10062.fqn:null);
switch (G__10062__$1) {
case "fail":
...
var G__10066 = (function (){var G__10065 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10065);
} else {
return G__10065;
}
})();
...
return cljs.core.vary_meta.call(null,G__10067,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10071 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10071,(0),null);
var types = vec__10071;
...
return cljs.core.map.call(null,(function (p__10074){
var vec__10075 = p__10074;
var ns = cljs.core.nth.call(null,vec__10075,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10075,(1),null);
return ((function (vec__10075,ns,vars__$1){
return (function (){
...
var G__10078 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__10078__$1 = (((G__10078 instanceof cljs.core.Keyword))?G__10078.fqn:null);
switch (G__10078__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1){
return (function (){
var seq__10079 = cljs.core.seq.call(null,vars__$1);
var chunk__10080 = null;
var count__10081 = (0);
var i__10082 = (0);
while(true){
if((i__10082 < count__10081)){
var v = cljs.core._nth.call(null,chunk__10080,i__10082);
var temp__5457__auto___10084 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10084)){
var t_10085 = temp__5457__auto___10084;
each_fixture_fn.call(null,((function (seq__10079,chunk__10080,count__10081,i__10082,t_10085,temp__5457__auto___10084,v,each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10085)));
});})(seq__10079,chunk__10080,count__10081,i__10082,t_10085,temp__5457__auto___10084,v,each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1))
);
} else {
}


var G__10086 = seq__10079;
var G__10087 = chunk__10080;
var G__10088 = count__10081;
var G__10089 = (i__10082 + (1));
seq__10079 = G__10086;
chunk__10080 = G__10087;
count__10081 = G__10088;
i__10082 = G__10089;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10079);
if(temp__5457__auto__){
var seq__10079__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10079__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__10079__$1);
var G__10090 = cljs.core.chunk_rest.call(null,seq__10079__$1);
var G__10091 = c__4351__auto__;
var G__10092 = cljs.core.count.call(null,c__4351__auto__);
var G__10093 = (0);
seq__10079 = G__10090;
chunk__10080 = G__10091;
count__10081 = G__10092;
i__10082 = G__10093;
continue;
} else {
var v = cljs.core.first.call(null,seq__10079__$1);
var temp__5457__auto___10094__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10094__$1)){
var t_10095 = temp__5457__auto___10094__$1;
each_fixture_fn.call(null,((function (seq__10079,chunk__10080,count__10081,i__10082,t_10095,temp__5457__auto___10094__$1,v,seq__10079__$1,temp__5457__auto__,each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10095)));
});})(seq__10079,chunk__10080,count__10081,i__10082,t_10095,temp__5457__auto___10094__$1,v,seq__10079__$1,temp__5457__auto__,each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1))
);
} else {
}


var G__10096 = cljs.core.next.call(null,seq__10079__$1);
var G__10097 = null;
var G__10098 = (0);
var G__10099 = (0);
seq__10079 = G__10096;
chunk__10080 = G__10097;
count__10081 = G__10098;
i__10082 = G__10099;
continue;
}
} else {
...
});})(each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1))
);
});})(each_fixture_fn,G__10078,G__10078__$1,env,once_fixtures,each_fixtures,vec__10075,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10078__$1)].join('')));

}
})());
});
;})(vec__10075,ns,vars__$1))
