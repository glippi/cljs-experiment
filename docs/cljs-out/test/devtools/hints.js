...
var file = cljs.core.get.call(null,map__11833__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11833__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11833__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e11832){var _e = e11832;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___11835 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___11835)){
var seen_errors_11836 = temp__5455__auto___11835;
if(cljs.core.truth_(seen_errors_11836.has(self))){
} else {
seen_errors_11836.add(self);

var temp__5457__auto___11837 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___11837)){
var sense_11838 = temp__5457__auto___11837;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11838)].join('');
} else {
}
}
} else {
