...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__12283 = cljs.core.second(format);
var G__12284 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__12283,G__12284) : ajax.easy.keyword_response_format_element.call(null,G__12283,G__12284));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12287_SHARP_){
return ajax.easy.keyword_response_format_element(p1__12287_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__12288){
var map__12289 = p__12288;
var map__12289__$1 = ((((!((map__12289 == null)))?(((((map__12289.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12289.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12289):map__12289);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12289__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12289__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12289__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__12289,map__12289__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__12291){
var vec__12292 = p__12291;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12292,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12292,(1),null);
var fexpr__12295_12296 = (cljs.core.truth_(ok)?h:e);
(fexpr__12295_12296.cljs$core$IFn$_invoke$arity$1 ? fexpr__12295_12296.cljs$core$IFn$_invoke$arity$1(result) : fexpr__12295_12296.call(null,result));
...
;})(h,e,map__12289,map__12289__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__12297){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12298__$1,cljs.core.cst$kw$body);
