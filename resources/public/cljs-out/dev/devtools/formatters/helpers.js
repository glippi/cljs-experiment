...
var G__19463 = devtools.prefs.pref.call(null,v);
v = G__19463;
continue;
} else {
return v;
...
}catch (e19466){var _e__18719__auto__ = e19466;
return false;
}})();
...
}catch (e19470){var _e__18719__auto__ = e19470;
return false;
}})();
...
}catch (e19472){var _e__18719__auto__ = e19472;
return false;
}}
}
});
...
var vec__19474 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19474,(0),null);
var name = cljs.core.nth.call(null,vec__19474,(1),null);
...
return cljs.core.some.call(null,(function (p1__19477_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19477_SHARP_);
}),template);
});
