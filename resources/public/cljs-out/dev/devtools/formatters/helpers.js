...
var G__19476 = devtools.prefs.pref.call(null,v);
v = G__19476;
continue;
} else {
return v;
...
}catch (e19479){var _e__18732__auto__ = e19479;
return false;
}})();
...
}catch (e19483){var _e__18732__auto__ = e19483;
return false;
}})();
...
}catch (e19485){var _e__18732__auto__ = e19485;
return false;
}}
}
});
...
var vec__19487 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19487,(0),null);
var name = cljs.core.nth.call(null,vec__19487,(1),null);
...
return cljs.core.some.call(null,(function (p1__19490_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19490_SHARP_);
}),template);
});
