...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19519){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19520,G__19521,seq19519__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19525_SHARP_){
return !((cljs.core.meta.call(null,p1__19525_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__19526__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e19530){var _e__18732__auto__ = e19530;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e19532){var _e__18732__auto__ = e19532;
return false;
}}
})())){
...
var _STAR_current_state_STAR_19534 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__19535 = opts;
...
var markup_db = cljs.core.get.call(null,map__19535__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_19534;
}});
...
;
var temp__5455__auto___19539 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___19539)){
var managed_print_level_19540 = temp__5455__auto___19539;
var _STAR_print_level_STAR_19538_19541 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_19540;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_19538_19541,managed_print_level_19540,temp__5455__auto___19539,writer,opts,job_fn){
return (function (p1__19537_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19537_SHARP_,null);
});})(_STAR_print_level_STAR_19538_19541,managed_print_level_19540,temp__5455__auto___19539,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_19538_19541;
}} else {
job_fn.call(null);
}
