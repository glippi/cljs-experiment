...
var o18892 = temp__5455__auto__;
var temp__5455__auto____$1 = (o18892["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o18893 = temp__5455__auto____$1;
return (o18893["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18712__auto__ = f;
return (o__18712__auto__["toString"]).call(o__18712__auto__);
} else {
return "";
}
}catch (e18894){var _ = e18894;
return "";
}});
...
try{var o__18712__auto___18896 = t;
(o__18712__auto___18896["cljs$lang$ctorPrWriter"]).call(o__18712__auto___18896,t,writer);
}catch (e18895){var __18897 = e18895;
}
...
var char_code = (function (){var o__18712__auto__ = (new String(char$));
return (o__18712__auto__["charCodeAt"]).call(o__18712__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18712__auto__ = String;
return (o__18712__auto__["fromCharCode"]).call(o__18712__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18898 = num_code;
switch (G__18898) {
case (1):
return (185);
...
var o__18712__auto__ = String;
return (o__18712__auto__["fromCharCode"]).call(o__18712__auto__,superscript_code);
});
/**
...
}catch (e18900){var _e__18719__auto__ = e18900;
return false;
}})())){
...
var vec__18901 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18901,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o18904 = temp__5455__auto__;
var temp__5455__auto____$1 = (o18904["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o18905 = temp__5455__auto____$1;
return (o18905["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18908){
var vec__18909 = p__18908;
var ns_detector = cljs.core.nth.call(null,vec__18909,(0),null);
...
var G__18915 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18916 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18915;
remaining_tokens = G__18916;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18906){
var G__18907 = cljs.core.first.call(null,seq18906);
var seq18906__$1 = cljs.core.next.call(null,seq18906);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18907,seq18906__$1);
});
...
var vec__18920 = cljs.core.split_with.call(null,(function (p1__18919_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18919_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18920,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18920,(1),null);
...
var vec__18923 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18923,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18923,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18926 = cljs.core.rest.call(null,remaining_tokens);
var G__18927 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18926;
name_tokens = G__18927;
continue;
} else {
...
var vec__18930 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18930,(0),null);
var arity = cljs.core.nth.call(null,vec__18930,(1),null);
var vec__18933 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18933,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18933,(1),null);
var vec__18936 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18936,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18936,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18936,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18936,(3),null);
...
var vec__18942 = result;
var munged_ns = cljs.core.nth.call(null,vec__18942,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18942,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18942,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18942,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18942,(4),null);
var arity = cljs.core.nth.call(null,vec__18942,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__18946 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__18946,(0),null);
var args = cljs.core.nth.call(null,vec__18946,(1),null);
var vec__18949 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18949,(0),null);
var name = cljs.core.nth.call(null,vec__18949,(1),null);
...
var G__18952 = (arity + (1));
var G__18953 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18954){
var vec__18955 = p__18954;
var arity = cljs.core.nth.call(null,vec__18955,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18955,(1),null);
...
return cljs.core.get.call(null,arities,p1__18958_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__18959_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18962){
var vec__18963 = p__18962;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__18963,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18960){
var G__18961 = cljs.core.first.call(null,seq18960);
var seq18960__$1 = cljs.core.next.call(null,seq18960);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18961,seq18960__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__18971__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__18971__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__18971__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__18971__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18972 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__18972,(0),null);
var fn_name = cljs.core.nth.call(null,vec__18972,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__18972,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__18972,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__18972,(4),null);
var arity = cljs.core.nth.call(null,vec__18972,(5),null);
...
var o__18712__auto__ = f;
return (o__18712__auto__["getBasis"]).call(o__18712__auto__);
});
/**
...
}catch (e18976){var _e__18719__auto__ = e18976;
...
var G__18977 = (obj[cljs.core.first.call(null,path)]);
var G__18978 = cljs.core.rest.call(null,path);
obj = G__18977;
path = G__18978;
continue;
} else {
...
return (function (accum,p__18979){
var vec__18980 = p__18979;
var bit = cljs.core.nth.call(null,vec__18980,(0),null);
var protocol = cljs.core.nth.call(null,vec__18980,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18983){
var vec__18984 = p__18983;
var ns = cljs.core.nth.call(null,vec__18984,(0),null);
var name = cljs.core.nth.call(null,vec__18984,(1),null);
var selector = cljs.core.nth.call(null,vec__18984,(2),null);
...
return (function (p__18988){
var vec__18989 = p__18988;
var munged_name = cljs.core.nth.call(null,vec__18989,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__18989,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__18989,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__18987_SHARP_){
return (obj[cljs.core.first.call(null,p1__18987_SHARP_)]);
});})(name,sorted_matches,vec__18989,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
