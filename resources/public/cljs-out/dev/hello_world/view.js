...
var c__4322__auto__ = cljs.core.chunk_first.call(null,s__29464__$2);
var size__4323__auto__ = cljs.core.count.call(null,c__4322__auto__);
var b__29466 = cljs.core.chunk_buffer.call(null,size__4323__auto__);
if((function (){var i__29465 = (0);
while(true){
if((i__29465 < size__4323__auto__)){
var bar = cljs.core._nth.call(null,c__4322__auto__,i__29465);
cljs.core.chunk_append.call(null,b__29466,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hello_world.view.mapBars,bar], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"year","year",335913393).cljs$core$IFn$_invoke$arity$1(bar)], null)));

var G__29467 = (i__29465 + (1));
i__29465 = G__29467;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29466),hello_world$view$screen_component_$_iter__29463.call(null,cljs.core.chunk_rest.call(null,s__29464__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29466),null);
}
} else {
var bar = cljs.core.first.call(null,s__29464__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hello_world.view.mapBars,bar], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"year","year",335913393).cljs$core$IFn$_invoke$arity$1(bar)], null)),hello_world$view$screen_component_$_iter__29463.call(null,cljs.core.rest.call(null,s__29464__$2)));
}
} else {
return null;
}
