...
if((i < len)){
var k = (ks[i]);
var G__12901 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12902 = (i + (1));
m = G__12901;
i = G__12902;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__12903 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__12903) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__12903));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__12905 = c;
var G__12905__$1 = (((G__12905 == null))?null:G__12905.prototype);
if((G__12905__$1 == null)){
return null;
} else {
return (G__12905__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__12907 = c;
var G__12907__$1 = (((G__12907 == null))?null:G__12907.prototype);
if((G__12907__$1 == null)){
return null;
} else {
return (G__12907__$1["render"]);
}
})() == null))));
});
...
var G__12909 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12909) : reagent.impl.component.as_element.call(null,G__12909));
};
...
var _STAR_current_component_STAR_12915 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12915;
}});
...
return ((function (G__12916,G__12916__$1){
...
var c = this;
var G__12921_12923 = (c["cljsRatom"]);
if((G__12921_12923 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12921_12923);
}
...
var renders_12925 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12926 = cljs.core.first(cljs.core.vals(renders_12925));
if((cljs.core.count(renders_12925) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12925))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12926)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12926], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__12924 = name;
switch (G__12924) {
case "":
...
var G__12929 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__12929) : reagent.impl.component.global$module$create_react_class.call(null,G__12929));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__12930 = fiber;
var G__12930__$1 = (((G__12930 == null))?null:(G__12930["type"]));
if((G__12930__$1 == null)){
return null;
} else {
return (G__12930__$1["displayName"]);
}
})();
var parent = (function (){var G__12931 = fiber;
if((G__12931 == null)){
return null;
} else {
return (G__12931["return"]);
}
})();
var path = (function (){var G__12932 = parent;
var G__12932__$1 = (((G__12932 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__12932) : reagent.impl.component.fiber_component_path.call(null,G__12932)));
if((G__12932__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12932__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__12934 = c;
if((G__12934 == null)){
return null;
} else {
return (G__12934["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__12935._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__12937 = c;
if((G__12937 == null)){
return null;
} else {
return (G__12937["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__12939 = c;
if((G__12939 == null)){
return null;
} else {
return G__12939._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__12941 = instance;
if((G__12941 == null)){
return null;
} else {
return (G__12941["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__12942 = instance;
if((G__12942 == null)){
return null;
} else {
return G__12942._currentElement;
}
}
})();
var name = (function (){var G__12943 = elem;
var G__12943__$1 = (((G__12943 == null))?null:(G__12943["type"]));
if((G__12943__$1 == null)){
return null;
} else {
return (G__12943__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__12945 = elem;
if((G__12945 == null)){
return null;
} else {
return (G__12945["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__12946._owner;
}
}
})();
var path = (function (){var G__12947 = owner;
var G__12947__$1 = (((G__12947 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__12947) : reagent.impl.component.component_path.call(null,G__12947)));
if((G__12947__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12947__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__12948 = c;
var G__12948__$1 = (((G__12948 == null))?null:G__12948.constructor);
if((G__12948__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12948__$1);
}
}
})();
