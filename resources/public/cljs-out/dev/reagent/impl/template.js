...
var G__13009 = o;
(G__13009[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__13013 = o;
(G__13013[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__13015__i < G__13015__a.length) {G__13015__a[G__13015__i] = arguments[G__13015__i + 0]; ++G__13015__i;}
  args = new cljs.core.IndexedSeq(G__13015__a,0,null);
} 
...
var G__13018 = props;
var G__13018__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13018,cljs.core.cst$kw$id,id):G__13018);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13018__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__13019){
...
var props = map__13020__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13020__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__13020,map__13020__$1,props,class$){
return (function (c){
...
});})(map__13020,map__13020__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__13022){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13023__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__13023,map__13023__$1,on_write){
return (function (){
...
});})(node_value,map__13023,map__13023__$1,on_write))
);
} else {
...
var G__13026 = jsprops;
(G__13026["defaultValue"] = value);

(G__13026["onChange"] = ((function (G__13026,v,value,on_change){
return (function (p1__13025_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13025_SHARP_);
});})(G__13026,v,value,on_change))
);
...
var vec__13029 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13029,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13029,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13029,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___13033 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___13033 == null)){
} else {
var key_13034 = temp__5461__auto___13033;
(jsprops["key"] = key_13034);
}
...
var temp__5461__auto___13035 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___13035 == null)){
} else {
var key_13036 = temp__5461__auto___13035;
reagent.impl.template.oset(jsprops,"key",key_13036);
}
...
var G__13037 = reagent.impl.template.__GT_NativeWrapper();
(G__13037["name"] = c);
...
var G__13038 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13038) : reagent.impl.template.as_element.call(null,G__13038));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13041){
var G__13042 = cljs.core.first(seq13041);
var seq13041__$1 = cljs.core.next(seq13041);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13042,seq13041__$1);
});
...
break;
default:
var G__13048 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__13048;
continue;
...
var n__4408__auto___13050 = a.length;
var i_13051 = (0);
while(true){
if((i_13051 < n__4408__auto___13050)){
(a[i_13051] = reagent.impl.template.as_element((a[i_13051])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___13053 = a.length;
var i_13054 = (0);
while(true){
if((i_13054 < n__4408__auto___13053)){
var val_13055 = (a[i_13054]);
if(((cljs.core.vector_QMARK_(val_13055)) && ((reagent.impl.template.key_from_vec(val_13055) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_13054] = reagent.impl.template.as_element(val_13055));
...
var ctx = ({});
var vec__13057 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13057,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13057,(1),null);
...
var G__13060 = (cljs.core.count(argv) - first_child);
switch (G__13060) {
case (0):
...
case (1):
var G__13061 = comp;
var G__13062 = jsprops;
var G__13063 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__13061,G__13062,G__13063) : reagent.impl.template.global$module$react.createElement.call(null,G__13061,G__13062,G__13063));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__13060){
