var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=9eed59&fwbuild=test"};
...
document.write('<script>goog.require("hello_world.test_runner");</script>');
