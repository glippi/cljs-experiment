...
var o10644 = temp__5455__auto__;
var temp__5455__auto____$1 = (o10644["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o10645 = temp__5455__auto____$1;
return (o10645["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9748__auto__ = f;
return (o__9748__auto__["toString"]).call(o__9748__auto__);
} else {
return "";
}
}catch (e10646){var _ = e10646;
return "";
}});
...
try{var o__9748__auto___10648 = t;
(o__9748__auto___10648["cljs$lang$ctorPrWriter"]).call(o__9748__auto___10648,t,writer);
}catch (e10647){var __10649 = e10647;
}
...
var char_code = (function (){var o__9748__auto__ = (new String(char$));
return (o__9748__auto__["charCodeAt"]).call(o__9748__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9748__auto__ = String;
return (o__9748__auto__["fromCharCode"]).call(o__9748__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10650 = num_code;
switch (G__10650) {
case (1):
return (185);
...
var o__9748__auto__ = String;
return (o__9748__auto__["fromCharCode"]).call(o__9748__auto__,superscript_code);
});
/**
...
}catch (e10652){var _e__9755__auto__ = e10652;
return false;
}})())){
...
var vec__10653 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10653,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o10656 = temp__5455__auto__;
var temp__5455__auto____$1 = (o10656["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o10657 = temp__5455__auto____$1;
return (o10657["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___10664 = arguments.length;
var i__4532__auto___10665 = (0);
while(true){
if((i__4532__auto___10665 < len__4531__auto___10664)){
args__4534__auto__.push((arguments[i__4532__auto___10665]));

var G__10666 = (i__4532__auto___10665 + (1));
i__4532__auto___10665 = G__10666;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10660){
var vec__10661 = p__10660;
var ns_detector = cljs.core.nth.call(null,vec__10661,(0),null);
...
var G__10667 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10668 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10667;
remaining_tokens = G__10668;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10658){
var G__10659 = cljs.core.first.call(null,seq10658);
var seq10658__$1 = cljs.core.next.call(null,seq10658);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10659,seq10658__$1);
});
...
var vec__10672 = cljs.core.split_with.call(null,(function (p1__10671_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10671_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10672,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10672,(1),null);
...
var vec__10675 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10675,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10675,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10678 = cljs.core.rest.call(null,remaining_tokens);
var G__10679 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10678;
name_tokens = G__10679;
continue;
} else {
...
var vec__10682 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10682,(0),null);
var arity = cljs.core.nth.call(null,vec__10682,(1),null);
var vec__10685 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10685,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10685,(1),null);
var vec__10688 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10688,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10688,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10688,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10688,(3),null);
...
var vec__10694 = result;
var munged_ns = cljs.core.nth.call(null,vec__10694,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10694,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10694,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10694,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10694,(4),null);
var arity = cljs.core.nth.call(null,vec__10694,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__10698 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__10698,(0),null);
var args = cljs.core.nth.call(null,vec__10698,(1),null);
var vec__10701 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10701,(0),null);
var name = cljs.core.nth.call(null,vec__10701,(1),null);
...
var G__10704 = (arity + (1));
var G__10705 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10706){
var vec__10707 = p__10706;
var arity = cljs.core.nth.call(null,vec__10707,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10707,(1),null);
...
return cljs.core.get.call(null,arities,p1__10710_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10711_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10714){
var vec__10715 = p__10714;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10715,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10712){
var G__10713 = cljs.core.first.call(null,seq10712);
var seq10712__$1 = cljs.core.next.call(null,seq10712);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10713,seq10712__$1);
});
...
var G__10721 = arg;
var G__10721__$1 = (((G__10721 instanceof cljs.core.Keyword))?G__10721.fqn:null);
switch (G__10721__$1) {
...
var map__10723 = options;
var map__10723__$1 = ((((!((map__10723 == null)))?(((((map__10723.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10723.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10723):map__10723);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10723__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10723__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10723__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10723__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10724 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10724,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10724,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10724,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10724,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10724,(4),null);
var arity = cljs.core.nth.call(null,vec__10724,(5),null);
...
var o__9748__auto__ = f;
return (o__9748__auto__["getBasis"]).call(o__9748__auto__);
});
/**
...
}catch (e10728){var _e__9755__auto__ = e10728;
...
var G__10729 = (obj[cljs.core.first.call(null,path)]);
var G__10730 = cljs.core.rest.call(null,path);
obj = G__10729;
path = G__10730;
continue;
} else {
...
return (function (accum,p__10731){
var vec__10732 = p__10731;
var bit = cljs.core.nth.call(null,vec__10732,(0),null);
var protocol = cljs.core.nth.call(null,vec__10732,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10735){
var vec__10736 = p__10735;
var ns = cljs.core.nth.call(null,vec__10736,(0),null);
var name = cljs.core.nth.call(null,vec__10736,(1),null);
var selector = cljs.core.nth.call(null,vec__10736,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__10741,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10741,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10741,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10739_SHARP_){
return (obj[cljs.core.first.call(null,p1__10739_SHARP_)]);
});})(name,sorted_matches,vec__10741,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
